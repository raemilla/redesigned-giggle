class App extends React.Component {
  ...
  getPhaseComponents() {
    ...
    switch (phase) {
      ...
      case "1":
        return admin ? <AdminPhase1Main pitches={this.props.pitches} phase={this.props.phase} students={this.props.students} subset={this.props.size_of_pitch_subset} /> : <StudentPhase1Main pitches={this.props.pitches} votecount={this.props.size_of_pitch_subset} />
      case "2":
